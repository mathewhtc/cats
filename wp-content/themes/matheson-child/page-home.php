...
<div class="container">
  <div class="row">
    <div class="col-md-8">
    	<a href="/section/?section=5" class="cta showcase-mgn"><strong>/ Featured Project:</strong> RE Camera</a>
    </div>
    <div class="col-md-4">
...
<div class="row">
  <div class="col-md-4">
    <div class="widget widget-menu projects-list">
      ...
      <a href="/projects" class="viewall-cta">View all Projects</a>
	  <?php 
  ...
  <div class="col-md-4">
    <div class="widget widget-menu projects-list">
      ...
      <a href="/user-research" class="viewall-cta">View all Reports</a>
