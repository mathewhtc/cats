...
get_header(); ?>
         ...
         <div class="container title-container">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="page-title">Section: <span><?php $section = urldecode($wp_query->query_vars['section']); $term = get_term_by('id', $section, 'section'); echo $term->name ;?></span></h1><!-- .page-title -->
                </div>
            </div>
        </div>
	</header>
...
<div class="row">
    <div class="col-md-8">
		...
		<form method="post" id="photos-order">
		  ...
		  <select name="select" onchange='this.form.submit()'>
            ...
            <div class="projects" style="margin-bottom:50px;">
              ...
              <?php query_posts( array ( 'post_type' => 'project', 'posts_per_page' => -1, 'order' => $order, 'orderby' => $orderby, 'section' => $term->slug) ); ?>
              <ul>
          ...
          <?php query_posts(array ( 'post_type' => 'test', 'posts_per_page' => -1, 'order' => $order, 'orderby' => $orderby, 'section' => $term->slug ) ); ?>
          <div class="col-md-12">
	  ...
	  <?php query_posts(array ( 'post_type' => 'analytics', 'posts_per_page' => -1, 'order' => $order, 'orderby' => $orderby, 'section' => $term->slug ) ); ?>
          <div class="col-md-12">
            <div class="research" style="margin-bottom:50px;">
              ...
              <?php else: ?>
              <p>No analytics reports available for <span class="term-name"><?php echo $term->name; ?></span></p>
              <?php endif; ?>
            </div>
          </div>
              <?php wp_reset_query(); ?>
